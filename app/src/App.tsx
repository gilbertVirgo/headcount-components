					...
					<Combo.Body>
						<Grid>
							<Grid.Cell>
								...
								<Text flex={3} noMargin marginLeft textSmall>John S. Doe</Text>
							</Grid.Cell>
							<Grid.Cell>
								<View flex={1} alignCenter>
									<FontAwesomeIcon icon={faHome} />
								</View>
								<Text flex={3} noMargin marginLeft textSmall>Best Barber Shop</Text>
							</Grid.Cell>
							<Grid.Cell>
								<View flex={1} alignCenter>
									<FontAwesomeIcon icon={faPhone} />
								</View>
								<Text flex={3} noMargin marginLeft textSmall>(+44) 1234 567 890</Text>
							</Grid.Cell>
							<Grid.Cell>
								<View flex={1} alignCenter>
									<FontAwesomeIcon icon={faMapPin} />
								</View>
								<Text flex={3} noMargin marginLeft textSmall>17 Barbers Place, E2 2D0</Text>
							</Grid.Cell>
						</Grid>
					...
					<Combo.Body>
						<Grid>
							<Grid.Cell>
								...
								<Text flex={3} marginLeft textSmall>(+44) 1234 567 890</Text>
							</Grid.Cell>
							<Grid.Cell>
								<View flex={1} alignCenter>
									<FontAwesomeIcon icon={faMapPin} />
								</View>
								<Text flex={3} marginLeft textSmall>Old Street, E1</Text>
							</Grid.Cell>
						</Grid>
						<RoundedRect noRadius>
							<Text>
